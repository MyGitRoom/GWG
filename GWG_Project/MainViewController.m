...
@property (nonatomic, strong) UIButton * mainBtn; //播放音频按钮
@property (nonatomic ,assign) BOOL isPlay ; //控制是否为播放状态 ;
...
@property (nonatomic ,strong) LazyFadeInView *wordView ; //创建文件渐变的view
@property (nonatomic ,strong) NSString *word ; //要显示文字
@end
